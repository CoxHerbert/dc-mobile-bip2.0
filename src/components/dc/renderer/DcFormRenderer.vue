<template>
    <view class="dc-form">
        <u-form class="dc-form-content" ref="form" :model="form" :error-type="['border-bottom', 'toast']">
...
import { deepClone, validateNull, findObject } from '@/components/wf-ui/util/index.js';

export default {
    name: 'dc-form-renderer',
    mixins: [Dic],
    emits: ['input', 'submit'],
    props: {
        option: {
